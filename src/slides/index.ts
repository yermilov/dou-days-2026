...
export const slides = [TitleSlide, BioSlide, TimelineSlide, EveryOrgRightNowSlide, InceptionPatternsSlide, ContextToolsSlide, DisclaimerSlide, ImportantSlide, BreakOutOfCodingSlide, SoftwareFactorySlide, WhatIsSkillSlide, SkillFlywheelSlide, SkillsPyramidSlide, SkillMarketplaceSlide, MetaSkillsSlide, AutoApproveHookSlide, AIInnovatorCurveSlide, SkillsActivatorSlide, SkillsMetricsSlide, AgentsSlide, AgentWorkflowSlide, AgentTracesSlide, AgentExampleSlide, OrgSectionSlide, IndustryPatternsSlide, OrgDecisionSlide, AutonomousAiSlide, HumanAiEngSlide, ChallengeAssumptionsSlide, ClaudeCodeSlide, FinalSlide];
